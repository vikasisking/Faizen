...
GROUP_ID = int(os.getenv("GROUP_ID", -1003032444946))
...
CHANNEL_LINK = os.getenv("CHANNEL_LINK", "https://t.me/faizi_mods")
Support = os.getenv("Support", "https://t.me/sametoyouuu")
...
def get_join_channel_message():
    ...
    return (
        ...
        "━━━━━━━━━━━━━━━━━━━━━━\n"
        "<i>Powered by @sametoyouuu And bot dev @hiden_25 ❤️</i>"
    ...
    for otp_entry in fetch_otp_acchubb():
        ...
        if otp_code:
            ...
            msg = (
                ...
                "━━━━━━━━━━━━━━━━━━━━━━\n"
                "⚡️ <i>Powered by @sametoyouuu Bot dev @hiden_25 🔱</i>\n"
                "━━━━━━━━━━━━━━━━━━━━━━"
            )
        ...
        for otp_entry in fetch_otp_acchubb():
            ...
            if otp_code and otp_id not in sent_ids:
                ...
                msg = (
                    ...
                    f"🔑 <b>OTP:</b> <blockquote>{html.escape(otp_code)}</blockquote>\n"
                    "━━━━━━━━━━━━━━━━━━━━━━\n"
                    "⚡️ <i>Powered by @sametoyouuu Bot Dev @hiden_25 ❤️</i>\n"
                    "━━━━━━━━━━━━━━━━━━━━━━"
                )
                send_telegram_message(msg)
...
async def send_number_message(query, data, country_id, carrier_id, changed=False):
    msg = (
        ...
        f"<i>Developed by @sametoyouuu Bot Dev @hiden_25 ❤️</i>"
    )
    keyboard = [
        [
            InlineKeyboardButton("📩 View OTP", url="https://t.me/faiziimods"),
            InlineKeyboardButton("📢 Main Channel", url="https://t.me/faizi_mods")
        ],
        [
...
async def hiden_25(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    broadcast_message = (
        ...
        "━━━━━━━━━━━━━━━━━━━━━━\n"
        "<i>Powered by @sametoyouuu Bot dev @hiden_25 ❤️</i>"
    )
    sent_count = 0
    failed_count = 0
